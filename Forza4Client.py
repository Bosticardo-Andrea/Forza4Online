...
def main():#main
    ...
    G1 = client.recv(1024).decode()
    os.system("cls")
    G2 = input("inserisci il tuo nome: ")
    client.send(G2.encode())
    giocatori = {G1:"X",G2:"O"}
    while(True):
        ...
        while(True):
            ...
            cella,griglia = controllo(m,G2,griglia,giocatori)#controllo che la mossa sia valida 
